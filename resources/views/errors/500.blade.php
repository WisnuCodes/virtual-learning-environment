...
<div style="background-color: var(--bg-secondary); min-height: calc(100vh - 73px); display: flex; align-items: center; justify-content: center; padding: 40px 20px; font-family: 'Poppins', sans-serif; background-image: radial-gradient(#cbd5e1 1px, transparent 1px); background-size: 24px 24px;">
    <div style="background: #fff; border: 4px solid #000; box-shadow: 15px 15px 0px 0px #d97706; width: 600px; max-width: 100%; padding: 60px 40px; text-align: center; position: relative;">
        
        <div style="position: absolute; top: -30px; left: 50%; transform: translateX(-50%); width: 80px; height: 80px; background: #d97706; color: #fff; border: 4px solid #000; display: flex; align-items: center; justify-content: center; font-size: 40px; box-shadow: 6px 6px 0px 0px #000;">
        ...
        <div style="margin-top: 20px;">
            <h1 style="font-size: 120px; font-weight: 900; color: #000; line-height: 1; margin: 0; letter-spacing: -5px; position: relative;">
                500
                <span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 20px; color: #d97706; background: #fff; padding: 5px 15px; border: 3px solid #000; letter-spacing: 2px; text-transform: uppercase; white-space: nowrap;">Kesalahan Server</span>
            </h1>
            
            <div style="margin: 40px 0;">
                <p style="font-size: 18px; font-weight: 800; color: #000; text-transform: uppercase; letter-spacing: 1px; line-height: 1.4;">
                    Terjadi kendala pada sistem internal kami.
                </p>
                <div style="width: 60px; height: 4px; background: #000; margin: 20px auto;"></div>
                <p style="font-size: 14px; color: #475569; font-weight: 600;">
                    Maaf atas ketidaknyamanannya. Tim teknis kami telah menerima laporan ini dan sedang berupaya melakukan perbaikan infrastruktur secepat mungkin.
                </p>
            </div>
        ...
        <div style="margin-top: 50px; font-size: 10px; font-weight: 900; color: #94a3b8; text-transform: uppercase; letter-spacing: 2px;">
            RUANGKELAS. TECHNICAL CORE &bull; 2026
        </div>
    </div>
</div>
@endsection
